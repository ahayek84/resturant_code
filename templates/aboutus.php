  	...
  	<div class="container">
        ...
        ?>
          ...
          <div class="edit-button-wrapper">
            <a class="btn btn-default second-background color-white" href="/editaboutus/<?php if(isset($_SESSION['restaurant_id'])) echo $_SESSION['restaurant_id'] ?>" role="button">Edit Restaurant Information</a>
          </div>
