...
class AuthController extends Controller{
	...
	public function requestPasswordReset($request, $response, $args){
		...
		return $this->view->render($response, 'success.php', array('status' => 1));
	...
	public function signInMobileUserDelivery($request, $response, $args){
		//system login
		$email = $request->getParam('EMAIL');
		$password = $request->getParam('PASSWORD');
	...
	public function signInMobileAdminUser($request, $response, $args){
		$email = $request->getParam('EMAIL');
		$password = $request->getParam('PASSWORD');
